...
if __name__ == '__main__':
    ...
    text = 'She and her brother play games online and use the Internet a lot, \
    for example, they go on Youtube and play MineCraft and chat online a lot \
    while they play video games at home.'
